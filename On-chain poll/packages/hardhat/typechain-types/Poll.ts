...
export namespace PollCreatedEvent {
  ...
  export type OutputTuple = [pollId: bigint, question: string, endTime: bigint];
...
export interface Poll extends BaseContract {
  ...
  createPoll: TypedContractMethod<
    [_question: string, _options: string[], _duration: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  filters: {
    "PollCreated(uint256,string,uint256)": TypedContractEvent<
      PollCreatedEvent.InputTuple,
      PollCreatedEvent.OutputTuple,
      PollCreatedEvent.OutputObject
    >;
